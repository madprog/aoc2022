...
.sum_sizes_at_most:
    ...
    test %r8, %r8
    jz .sum_sizes_at_most_contents_loop_end # not a directory
    cmpq %rsi, 20(%rdi)
    ja .sum_sizes_at_most_contents_loop
    mov 20(%rdi), %rbx
.sum_sizes_at_most_contents_loop:
    push %rdi
    mov %r8, %rdi
    call .sum_sizes_at_most
    pop %rdi
    ...
    test %r8, %r8
    jnz .sum_sizes_at_most_contents_loop
.sum_sizes_at_most_contents_loop_end:
    mov %rbx, %rax
    pop %r8
    pop %rbx
    ret
